...
class PA_Widget_Product_Carousel extends PA_Widgets {
	...
	public function render( $settings = array(), $content = '' ) {
		...
		$args = 'extension/module/pavobuilder/product_carousel/product_carousel';
	...
	private function getProducts( $results, $setting ){
        ...
        foreach ($results as $result) {
            if ( ! empty( $result['image'] ) ) {
				...
				$src = empty( $setting['product_size'] ) || $setting['product_size'] == 'full' ? $server . 'image/' . $result['image'] : false;
				if ( $src === false && strpos( $setting['product_size'], 'x' ) ) {
